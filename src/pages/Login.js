...
class LoginForm extends Component {
  ...
  componentDidMount() {
    document.body.style.backgroundColor='rgb(223, 203, 203)';
      ...
      <div className='login-form'>
        <Grid textAlign='center' style={{ height: '100%' }} verticalAlign='middle'>
          ...
          <Header as='h2' color='teal' textAlign='center'>
            ...
            <Message>
              Don't have an account? <Link to='/sign-up'>Sign up!</Link><br/>Email: <strong>mary.ondire@gmail.com</strong><br/>Password: <strong>12345</strong><br/>
            </Message>
          </Grid.Column>
        </Grid>
      </div>
